...
ExpEval.scatter_dist_matrices!(M1, M2, save_as="figs/$figname", label="A correction factor")

M2 = ExpEval.calculate_distance_matrix_dtwA(TRAIN, 2)
ExpEval.scatter_dist_matrices!(M1, M2, save_as="figs/$figname", label="B correction factor")